...
const AiNetworkIcon = ({ className }: { className?: string }) => (
	<svg
	...
	>
		...
		<path d='M5.549 11.951c0-3.064 0-4.596.952-5.548s2.484-.952 5.548-.952 4.596 0 5.548.952.952 2.484.952 5.548 0 4.596-.952 5.548-2.484.952-5.548.952-4.596 0-5.548-.952-.952-2.484-.952-5.548Z' />
		<path
